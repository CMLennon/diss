...
Despite an enormous amount of work - this part is pretty boring. The sample size (oos) is small, so standard errors are large, but the point estimate is very close to the old one -

$$\theta_{OOD} \approx .0104$$
