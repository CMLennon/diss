...
- Produces causal estimates of property value on fire suppression costs, conditional on fire risk attributes
...
#pagedown::chrome_print(input = "5-slide-deck-SCI-2.html")
```
